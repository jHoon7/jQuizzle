...
def format_question(question_data):
    ...
    for emoji, option in zip(emojis, options):
        formatted_text += f"{emoji} {option}\n"
        if option == correct_answer:
            correct_answer_emoji = emoji
    
    # Add the correct answer with its matching emoji
...
def main():
    ...
    formatted_question, shuffled_options = format_question(question_data)
    
    # Try to copy to clipboard
    if copy_to_clipboard(formatted_question):
